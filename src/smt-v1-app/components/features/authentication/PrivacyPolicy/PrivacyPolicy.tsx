  ...
  return (
    <div className="container mt-4">
      ...
      <div className="tab-content translations-content-item en visible" id="en">
        ...
        <h3 className="mb-3">Interpretation</h3>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Asparel Yazılım , Tasarım A.Ş., İzmir
              Teknopark Yerleşkesi A8 Binası , Urla/Izmir Turkey.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Sale Management Tool,
              accessible from{' '}
              <a
                href="asparel.com.tr"
        ...
        <h4 className="mb-2">Personal Data</h4>
        <p>
        ...
        <h4 className="mb-2">Usage Data</h4>
        ...
        <h4 className="mb-2">Tracking Technologies and Cookies</h4>
        <p>
        ...
        <h3 className="mb-2">Use of Your Personal Data</h3>
        ...
        <h3 className="mb-3">Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className="mb-3">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className="mb-3">Delete Your Personal Data</h3>
        <p>
        ...
        <h3 className="mb-3">Disclosure of Your Personal Data</h3>
        <h4 className="mb-2">Business Transactions</h4>
        <p>
        ...
        <h4 className="mb-2">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="mb-2">Other legal requirements</h4>
        <p>
